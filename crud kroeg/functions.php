...
function insertkroeg($post){
    ...
    // Maak een query 
    $sql = "
        INSERT INTO " . CRUD_TABLE . " (naam, adres, kroegcode, plaats)
        VALUES (:naam, :adres, :kroegcode, :plaats) 
    ";
    ...
    $stmt->execute([
        ':naam' => $post['naam'],
        ':plaats' => $post['plaats'],
        ':adres' => $post['adres'], // Assuming stijl is a field in your table
        ':kroegcode' => $post['kroegcode']
    ]);
